...
# Define Package URL
FILE_URL="https://github.com/MissouriMRDT/Autonomy_Packages/raw/main/pcl/arm64/pcl_${PCL_VERSION}_arm64.deb"
...
if [[ "$DOWNLOAD_LATEST" == true ]]; then
    ...
    curl -L $FILE_URL --output /tmp/pkg/deb/pcl_${PCL_VERSION}_arm64.deb
