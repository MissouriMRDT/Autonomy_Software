...
void RunExample()
{
    ...
    yolomodel::tensorflow::TPUInterpreter ExampleEdgeTPUModel =
        yolomodel::tensorflow::TPUInterpreter("../data/models/yolo_models/coco_v5n_x640/best.tflite", yolomodel::tensorflow::TPUInterpreter::eMax);
    ...
    while (true)
    {
        ...
        if (fuCopyStatus1.get() && !cvNormalFrame1.empty())
        {
            ...
            std::vector<yolomodel::Detection> vObjects = ExampleEdgeTPUModel.Inference(cvNormalFrame1, 0.50f, 0.99f);
