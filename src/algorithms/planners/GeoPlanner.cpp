...
namespace pathplanners
{
     ...
     * @param dMinTravScore - The minimum traversal score threshold for considering points in the path.
        ...
        while (!m_pqOpenSetNextBest.empty())
        {
            ...
            for (LiDARHandler::PointRow& stPoint : vNeighbors)
            {
                ...
                */
                ...
                if (itNeighborState == m_umAllStates.end() || dTentativeGCost < itNeighborState->second.dGCost)
                {
