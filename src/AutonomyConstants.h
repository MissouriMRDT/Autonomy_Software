...
namespace constants
{
    ...
    const double ARUCO_BBOX_MIN_AREA                    = 5000;    // Minumum area of AR tag for ARUCO to start tracking
    ///////////////////////////////////////////////////////////////////////////
    ...
    const double APPROACH_MARKER_VISION_DISTANCE     = 15.0;    // This is an arbitrary distance based on the aread of the tag. Used only for vision driving.
