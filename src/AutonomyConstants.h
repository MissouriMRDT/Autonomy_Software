...
namespace constants
{
...
#endif
    const std::string SIM_IP_ADDRESS = "10.8.0.2";    // The IP address to use for simulation mode.
    ...
    const tracking::TrackerType ARUCO_DNN_TRACKER_TYPE = tracking::TrackerType::eKCF;    // The type of tracker to use for the DNN detection. KCF is fast and accurate.
    ///////////////////////////////////////////////////////////////////////////
