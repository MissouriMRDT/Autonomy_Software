...
namespace globals
{
    ...
    void AdjustAutonomyConstants()
    {
        ...
        if (std::filesystem::exists(pathToDrive))    // no USB drive
        {
            ...
            // Power ants.
            constants::DRIVE_MAX_POWER  = jsonData["DriveConstants"]["drive_max_power"];
            constants::DRIVE_MIN_POWER  = jsonData["DriveConstants"]["drive_min_power"];
            constants::DRIVE_MAX_EFFORT = jsonData["DriveConstants"]["drive_max_effort"];
            constants::DRIVE_MIN_EFFORT = jsonData["DriveConstants"]["drive_min_effort"];

            // Control  ants.
            constants::DRIVE_PID_PROPORTIONAL =
            ...
            constants::DRIVE_PID_MAX_ERROR_PER_ITER =
                jsonData["DriveConstants"]
            ...
            constants::DRIVE_PID_MAX_INTEGRAL_TERM = jsonData["DriveConstants"]["drive_pid_max_integral_term"];    // The max effort the I term is allowed to contribute.
            constants::DRIVE_PID_MAX_OUTPUT_EFFORT =
                jsonData["DriveConstants"]
            ...
            constants::DRIVE_PID_MAX_RAMP_RATE = jsonData["DriveConstants"]["drive_pid_max_ramp_rate"];    // The max ramp rate of the output of the PID controller.
            constants::DRIVE_PID_OUTPUT_FILTER =
            ...
            constants::DRIVE_PID_OUTPUT_REVERSED = jsonData["DriveConstants"]["drive_pid_output_reversed"];    // Negates the output of the PID controller.
            ...
            // ZedCam Basic Config.
            constants::ZED_BASE_RESOLUTION = jsonData["CameraConstants"]["zed_base_resolution"];    // The base resolution to open the all cameras with.
            constants::ZED_MEASURE_UNITS   = jsonData["CameraConstants"]["zed_measure_units"];      // The base measurement unit to use for depth.
            constants::ZED_COORD_SYSTEM    = jsonData["CameraConstants"]["zed_coord_system"];       // Coordinate system to use for measurements.
            constants::ZED_DEPTH_MODE      = jsonData["CameraConstants"]["zed_retrieve_view"];      // The measurement accuracy for depth. NEURAL is by far the best.
            constants::ZED_RETRIEVE_VIEW   = jsonData["CameraConstants"]["zed_sensing_fill"];       // The eye to retrieve regular and depth images from.
            constants::ZED_SENSING_FILL =
            ...
            constants::ZED_DEPTH_STABILIZATION = 1;    // This parameter controls a stabilization filter that reduces oscillations in depth map. In the range [0-100]
            // ZedCam Positional Tracking Config.
            constants::ZED_POSETRACK_MODE = jsonData["CameraConstants"]["zed_posetrack_mode"];    // Positional tracking accuracy.
            constants::ZED_POSETRACK_AREA_MEMORY =
            ...
            constants::ZED_POSETRACK_ENABLE_IMU_FUSION =
            ...
            constants::ZED_POSETRACK_USABLE_DEPTH_MIN =
                jsonData["CameraConstants"]
            ...
            constants::ZED_POSETRACK_USE_GRAVITY_ORIGIN =
            ...
            constants::ZED_MAPPING_TYPE = jsonData["CameraConstants"]["zed_mapping_type"];    // Mesh or point cloud output.
            constants::ZED_MAPPING_RANGE_METER =
            ...
            constants::ZED_MAPPING_RESOLUTION_METER =
            ...
            constants::ZED_MAPPING_STABILITY_COUNTER =
            ...
            constants::ZED_OBJDETECTION_SEGMENTATION =
            ...
            constants::ZED_OBJDETECTION_FILTERING = jsonData["CameraConstants"]["zed_objdetection_filtering"];    // Custom detection, use PER_CLASS or NONE.
            constants::ZED_OBJDETECTION_TRACKING_PREDICTION_TIMEOUT =
            ...
            constants::ZED_OBJDETECTION_BATCH_RETENTION_TIME =
            ...
            constants::ZED_OBJDETECTION_BATCH_LATENCY =
                jsonData["CameraConstants"]["zed_objdetection_batch_latency"];           // Short latency will limit the search for previously seen
            ...
            constants::ZED_MAINCAM_FPS = jsonData["CameraHandlerAdjustments"]["zed_maincam_fps"];    // The FPS to use for the maincam.
            ...
            constants::BASICCAM_LEFTCAM_FPS = jsonData["CameraHandlerAdjustments"]["basiccam_leftcam_fps"];    // The FPS to use for the maincam.
            ...
            constants::BASICCAM_LEFTCAM_INDEX     = jsonData["CameraHandlerAdjustments"]["basiccam_leftcam_index"];        // The /dev/video index of the camera.
            constants::BASICCAM_LEFTCAM_PIXELTYPE = jsonData["CameraHandlerAdjustments"]["basiccam_leftcam_pixeltype"];    // The pixel layout of the camera.
            ///////////////////////////////////////////////////////////////////////////
        }
    }
}    // namespace globals
