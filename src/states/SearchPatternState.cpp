...
namespace statemachine
{
    ...
    /******************************************************************************
     * @brief This method takes in a skeleton path of waypoints and removes any waypoints that are in red zones (obstacles) based on LiDAR data.
     *
     * @param vSkeletonPath - The input skeleton path of waypoints that the search pattern should weave through.
     *
    ...
    /******************************************************************************
     * @brief This method takes in a skeleton path of waypoints and uses the GeoPlanner to create a new path that weaves through the skeleton path while avoiding
     * obstacles.
     *
     * @param vSkeletonPath - The input skeleton path of waypoints that the search pattern should weave through.
     * @return std::vector<geoops::Waypoint> - The new path generated by the GeoPlanner that weaves through the skeleton path while avoiding obstacles.
     *
     * @author Hunter LeRette (hrlnpc@mst.edu), Jordan Hoover (jh69n@mst.edu), Aiden Buter (ab9hm@mst.edu)
     * @date 2026-05-17
     ******************************************************************************/
    ...
    void SearchPatternState::Run()
    {
        ...
        LOG_DEBUG_LIMIT(std::chrono::seconds(1), logging::g_qSharedLogger, "SearchPatternState: Running state-specific behavior.");
