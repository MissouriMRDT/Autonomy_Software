...
namespace constants
{
    ...
    const double APPROACH_MARKER_MOTOR_POWER          = DRIVE_MAX_POWER * 0.6;    // The amount of power the motors use when approaching the marker.
    ...
    const double APPROACH_OBJECT_MOTOR_POWER         = DRIVE_MAX_POWER * 0.6;    // The amount of power the motors use when approaching the object.
    ...
    // Reverse State.
    const double REVERSE_MOTOR_POWER       = DRIVE_MAX_POWER * 0.6;    // The speed to drive backwards at.
    ...
    const double SEARCH_MOTOR_POWER          = DRIVE_MAX_POWER * 0.5;    // The amount of power the motors use when approaching the marker.
    ...
    // Navigating State.
    const double NAVIGATING_MOTOR_POWER         = DRIVE_MAX_POWER * 0.8;    // The speed to drive at when navigating.
    ...
    // Avoidance State.
    const double AVOIDANCE_STATE_MOTOR_POWER = DRIVE_MAX_POWER * 0.3;    // Drive speed of avoidance state
    ...
    const double STANLEY_WHEELBASE               = 0.5;     // Distance from position sensor to the center of the front axle in meters.
    ...
    const double STANLEY_PREDICTION_TIME_STEP    = 0.05;    // The time to pass in seconds between each prediction of the Stanley controller bicycle model.
