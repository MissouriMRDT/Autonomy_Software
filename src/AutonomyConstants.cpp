...
namespace constants
{
    ...
    const double APPROACH_OBJECT_TAG_LOST_BUFFER_TIME = 2.0;     // The time in seconds to wait before considering the tag lost. This is used to prevent false negatives.
