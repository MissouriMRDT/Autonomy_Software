    ...
    namespace nodes
    {
        ...
        struct AStarNode
        {
            public:
                ...
                std::shared_ptr<AStarNode> pParentNode;    // A shared pointer to the parent node the this nodes comes after in the path.
                 ...
                 *
                 * @param pParentNode - A pointer to the parent node the this nodes comes after in the path.
                 ...
                 * @date 2024-02-01
                 ******************************************************************************/
                AStarNode(std::shared_ptr<AStarNode> pParentNode     = nullptr,
