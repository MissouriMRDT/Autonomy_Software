...
namespace tui::views
{
    ...
    inline Element RenderTelemetryView(const TuiTelemetrySnapshot& snap)
    {
        ...
        std::ostringstream ossEasting, ossNorthing, ossHeading, ossTarget, ossErr, ossDist;
        ...
        Element navPane = window(
            ...
            vbox({
                hbox({text(" UTM Easting:  ") | color(Color::GrayLight), text(ossEasting.str() + " m") | bold | color(Color::YellowLight)}),
                hbox({text(" UTM Northing: ") | color(Color::GrayLight), text(ossNorthing.str() + " m") | bold | color(Color::YellowLight)}),
        ...
        Element visionPane = window(
            text(" 👁️ VISION & SENSORS ") | bold | color(Color::MagentaLight),
            vbox({
                hbox({text(" Front ZED: ") | color(Color::GrayLight), text(std::to_string(static_cast<int>(snap.fMainCamFPS)) + " FPS") | bold | color(snap.fMainCamFPS > 20 ? Color::Green : Color::RedLight)}),
                hbox({text(" Rear ZED:  ") | color(Color::GrayLight), text(std::to_string(static_cast<int>(snap.fRearCamFPS)) + " FPS") | bold | color(snap.fRearCamFPS > 20 ? Color::Green : Color::RedLight)}),
                separator(),
        ...
        Element geoPane = window(
            text(" 🗺️ GEOPLANNER / LIDAR ") | bold | color(Color::YellowLight),
            vbox({
